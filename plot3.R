...
plot(sub_table$newT,sub_table$Sub_metering_1,type="l",ylab="Energy sub Metering",xlab="")
lines(sub_table$newT,sub_table$Sub_metering_2,type="l",col="red")
lines(sub_table$newT,sub_table$Sub_metering_3,type="l",col="blue")
legend("topright",lty=c(1,1),legend=c("sub_meter1","sub_meter2","sub_meter3"),col=c("grey","red","blue"))
